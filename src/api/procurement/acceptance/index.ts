...
// requestId: 关联采购申请 ID（新增草稿未落库时补台账关联）
// items: 验收明细数组（itemName/spec/applyPrice/quantity/id），files: 发票 PDF 数组
export function aiInvoiceMatch(items: any[], files: File[], acceptanceId?: string | number, requestId?: string | number): AxiosPromise<any> {
